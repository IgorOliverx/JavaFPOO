    ...
    public CadastroAgendamento() {
        ...
        cadastrarAgendaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                operacoes.cadastrarAgendamento(inputData.getText(), inputHora.getText(),(Usuario)comboUsuarios.getSelectedItem(),inputDescricao.getText());
                inputData.setText("");
                inputHora.setText("");
        ...
        atualizarAgendaButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                operacoes.atualizarAgendamento(linhaSelecionada, inputData.getText(), inputHora.getText(),(Usuario)comboUsuarios.getSelectedItem(),inputDescricao.getText());
            }
        });
